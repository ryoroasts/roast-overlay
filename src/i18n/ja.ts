...
export const ja: Dict = {
  ...
  aboutTitle: 'これは何か',
  aboutWhat:
    'Overlay は Kaffelogic で焙煎する人のためのブラウザツールです。.kpro を2本読み込むと、1枚のグラフに重ねて描き、それぞれの zone(zone1 / zone2 / corner1)を帯で示し、どの設定が違うかを表にします(予熱・PID・zone の時刻と boost・推奨 Level)。焙煎ごとに1つだけ変えて比べているので、その1つが見たくて作りました。.klog を読み込むと、実際に到達した温度と、機体が追いかけていた設計曲線を重ねて描き、どれだけ上下にずれ、いつ戻ったかも表示します。',
  aboutAlign:
  ...
  aboutNoteLead: '温度で揃えるという考え方は、毎週の焙煎とカッピングの記録から来ています。',
  aboutNoteLink: '焙煎記録(note・日本語)',
